...
GITHUB_REPO = "dimacmirnov41-netizen/ZapretLauncher"
...
class ZapretLauncher(ctk.CTk):
    def __init__(self):
        ...
        self.title_label = ctk.CTkLabel(self.header_frame, text="ZAPRET LAUNCHER", font=ctk.CTkFont(size=30, weight="bold"), text_color="#00d4ff")
